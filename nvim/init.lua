...
require('lazy').setup({
  ...
  { 'Bilal2453/luvit-meta', lazy = true },
  {
    ...
    config = function()
      ...
      vim.list_extend(ensure_installed, {
        ...
        'prettierd', -- Used to format ts/js code
  ...
  { -- Highlight, edit, and navigate code
    ...
    branch = 'main', -- the old 'master' branch is archived and breaks on nvim 0.12+
    lazy = false,
    build = ':TSUpdate',
    ...
    config = function()
      ...
      -- The 'main' branch has no highlight/indent modules; enable core
      -- treesitter per buffer whenever a parser is available.
